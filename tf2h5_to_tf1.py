...
"""
# https://raw.githubusercontent.com/amir-abdi/keras_to_tensorflow/master/keras_to_tensorflow.py
# This script needs to be executed in TensorFlow 1.15 version, not TensorFlow 2.0 or later
